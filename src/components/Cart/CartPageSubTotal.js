...
function CartPageSubTotal(props) {
    return (
        <div className="cartpage-subtotal" style={{border:"2px solid grey", width:"20rem", height:"12rem", marginTop:"14.6rem", marginLeft:"4rem", padding:"20px 30px 20px 30px"}}>
            ...
            <div className="proceed-checkout-button" style={{margin:"30px 2px 10px 2px"}}>
